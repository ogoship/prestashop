...
{block name="override_tpl"}
	...
	{/if}
	{if $ogoship==1}
	<form action="{$currentIndex|escape:'html':'UTF-8'}&amp;id_order={$order->id|intval}&amp;vieworder&amp;token={$smarty.get.token}" method="post" class="form-horizontal well hidden-print">
	<div class="row">
		<div class="col-lg-12">
			<div class="panel">
				<button type="submit" name="submitSendOrder" class="btn btn-primary">{l s='Send Order to Ogoship'}</button>
			</div>
		</div>
	</div>
	</form>
